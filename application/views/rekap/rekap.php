                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($rk['ket_rekap'] == "Draf") { ?>
                                        ...
                                        <a href="<?= base_url() . 'rekap/rekap_ket/' . $rk['id_rekap'] . '/' . "Tidak_Diusulkan"; ?>">
                                ...
                                <td>
                                    ...
                                    if ($rk['status'] == "Diterima") {
                                        if ($rk['kunci'] == "Ya") { ?>
                                            <a href="<?= base_url() . 'rekap/rekap_kunci/' . $rk['id_rekap'] . '/' . "Tidak"; ?>">
                                                <button type="button" class="btn btn-block btn-success btn-xs">Tidak</button></a>

                                        <?php } else if ($rk['kunci'] == "Tidak") { ?>
                                            <a href="<?= base_url() . 'rekap/rekap_kunci/' . $rk['id_rekap'] . '/' . "Ya"; ?>">
