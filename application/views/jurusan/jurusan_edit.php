...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <form role="form" method="post" action="<?php echo base_url() . 'jurusan/jurusan_edit/' . $jurusan['id_jurusan']; ?>">
                <div class="box-body">
                    <!-- kolom1 -->
                    <div class="col-md-6">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <select class="form-control" tabindex="-1" aria-hidden="true" name="id_fakultas">
                                    <option value="<?= $jurusan['id_fakultas']; ?>"><?= $jurusan['nama_fakultas']; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?= $jurusan['nama_jurusan']; ?>" name="nama_jurusan" class="form-control" id="exampleInputPassword1" placeholder="Nama fakultas">
                                <small class="form-text text-danger"><?= form_error('nama_jurusan'); ?></small>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Deskripsi Singkat</label>
                                <textarea name="ket_jur" class="form-control" rows="3"><?= $jurusan['ket_jur']; ?></textarea>
                            </div>
                        </div>
                    </div>
