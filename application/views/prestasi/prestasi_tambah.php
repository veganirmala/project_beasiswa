...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <form role="form" method="post" action="<?php echo base_url() . 'prestasi/prestasi_tambah_save'; ?>">
                <div class="box-body">
                    <!-- kolom1 -->
                    <div class="col-md-6">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <!-- <input type="text" value="<?= $thusulan['id_beasiswa']; ?>" name="nama_beasiswa" class="form-control" id="exampleInputPassword1" readonly> -->
                                <select class="form-control" tabindex="-1" aria-hidden="true" name="id_beasiswa">
