...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <form role="form" method="post" action="<?php echo base_url() . 'fakultas/fakultas_edit/' . $fakultas['id_fakultas']; ?>">
                <div class="box-body">
                    <!-- kolom1 -->
                    <div class="col-md-6">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?= $fakultas['nama_fakultas']; ?>" name="nama_fakultas" class="form-control" id="exampleInputPassword1">
                                <small class="form-text text-danger"><?= form_error('nama_fakultas'); ?></small>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Deskripsi Singkat</label>
                                <textarea name="keterangan" class="form-control" rows="3"><?= $fakultas['keterangan']; ?></textarea>
                            </div>
                        </div>
                    </div>
